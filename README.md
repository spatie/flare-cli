...
Personal and legacy tokens remain supported through `--token` for scripts and CI. Create and manage personal tokens under [Account → Access tokens](https://flareapp.io/account/personal-access-tokens).
